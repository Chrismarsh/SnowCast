...
# Dirs
netcdf_dir = '/media/data3/nicway/GEM/west/netcdf_archive'
os.chdir(netcdf_dir)
...
# File names
file_for = 'GEM_2_5km_west_%Y-%m-%dT%H:00:00.000000000.nc'
...
prv_ds = prv_ds.isel(datetime=np.arange(24,48)) # arange doesn't include the last number!!
...
ds_Qsi.set_coords({'gridlat_0','gridlon_0'},inplace=True)
...
ds_Qli.set_coords({'gridlat_0','gridlon_0'},inplace=True)
...
ds_out.set_coords({'gridlat_0','gridlon_0'},inplace=True)
# fix dim on gridlat_0...
ds_out['gridlat_0'] = prv_ds.gridlat_0
ds_out['gridlon_0'] = prv_ds.gridlon_0
